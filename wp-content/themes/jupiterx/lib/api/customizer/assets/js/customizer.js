    ...
    'jupiterx-template': {
      ...
      ready: function ready() {
        ...
        $edit.on('click', function (event) {
          ...
          $.featherlight({
            variant: 'jupiterx-template-lightbox',
            iframe: control.getEditTemplateUrl(),
            beforeOpen: control.lightboxPreloader,
            beforeClose: function beforeClose() {
              var iframe = void 0,
                  contentWindow = void 0,
                  status = void 0;

              iframe = this.$instance.find('iframe');
              if (!iframe.length) {
                return;
              }
              ...
              status = contentWindow.elementor.channels.editor.request('status');
              if (status === false) {
        ...
        $add.on('click', function (event) {
          ...
          $.featherlight({
            variant: 'jupiterx-template-lightbox',
            iframe: control.getNewTemplateUrl(),
            beforeOpen: control.lightboxPreloader,
            beforeClose: function beforeClose() {
              var iframe = void 0,
                  contentWindow = void 0;
      ...
      updateSelectTemplates: function updateSelectTemplates() {
        var control = this,
            ...
            action = 'jupiterx_customizer_elementor_templates',
      ...
      /**
       * Display Elementor preloader on lightbox.
       *
       * @since 1.0.0
       *
       * @returns {void}
       */
      lightboxPreloader: function lightboxPreloader() {
        var template = wp.template('customize-jupiterx-elementor-loader');
        this.$instance.find('.featherlight-content').append(template());
      },
